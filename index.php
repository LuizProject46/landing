...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    <a href="#home" class="w3-bar-item w3-button"><b>LGM</b> Projects</a>
    <!-- Float links to the right. Hide them on small screens -->
    <div class="w3-right w3-hide-small">
      <a href="#portifolio" class="w3-bar-item w3-button">Portifólio</a>
...
<header class="w3-display-container w3-content w3-wide" style="max-width:1500px;" id="home">
  <img class="w3-image" src="img/main.jpg" alt="Architecture" width="1500" height="800">
  
  <div class="w3-display-middle w3-margin-top w3-center">
    <h1 class="w3-xxlarge w3-text-white"><span class="w3-padding w3-black w3-opacity-min"><b>LGM</b></span> <span class="w3-hide-small w3-text-light-grey">Projects</span></h1>
  </div>
</header>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="portifolio">
    ...
    font-weight: 600;" class=" w3-border-light-grey w3-padding-16">Portifólio</h2>
  </div>
  ...
  <div class="w3-row-padding">
    <div style="width:50%;" class="w3-col l3 m6 w3-margin-bottom">
      <div class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">SocialSociety - Login</div>
        <img src="img/sc1.png" alt="SocialSociety - 1" style="width:100%">
      </div>
    </div>
    <div style="width:50%;" class="w3-col l3 m6 w3-margin-bottom">
      <div  class="w3-display-container">
        <div class="w3-display-topleft w3-black w3-padding">SocialSociety - Timeline</div>
        <img src="img/sc2.png" alt="SocialSociety - 2" style="width:100%">
      </div>
     <!--- 
    </div>
...
<!-- <div class="w3-container">
  <img src="img/img1.jpg" class="w3-image" style="width:100%">
</div> -->
